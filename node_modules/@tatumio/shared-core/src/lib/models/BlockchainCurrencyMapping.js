...
exports.BlockchainCurrencyMapping = {
    ...
    CHILIZ: api_client_1.Currency.CHZ,
    FLR: api_client_1.Currency.FLR,
    CRO: api_client_1.Currency.CRO,
    BASE: {
        nativeCurrency: api_client_1.Currency.ETH_BASE,
        currencies: api_client_1.BASE_BASED_CURRENCIES,
    },
    AVAX: api_client_1.Currency.AVAX,
    OPTIMISM: {
        nativeCurrency: api_client_1.Currency.ETH_OP,
        currencies: api_client_1.OPTIMISM_BASED_CURRENCIES,
    },
    FTM: api_client_1.Currency.FTM,
    TON: api_client_1.Currency.TON,
    ZK_SYNC: api_client_1.Currency.ZK_SYNC,
    RON: api_client_1.Currency.RON,
    S: api_client_1.Currency.S,
    KAIA: api_client_1.Currency.KAIA,
    BERA: api_client_1.Currency.BERA,
    SUI: api_client_1.Currency.SUI,
    UNI: api_client_1.Currency.ETH_UNI,
};
